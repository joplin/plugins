...
--- | --- | --- | --- | ---
[🏠](https://discourse.joplinapp.org/t/insert-referencing-notes-backlinks-plugin/13632) | Automatic Backlinks to note | 2.0.4 | Creates backlinks to opened note, also in automatic way | ambrt
...
[🏠](https://github.com/treymo/joplin-link-graph) | Link Graph UI | 0.9.4 | View the connections between Joplin notes. | Trey Moore
...
[🏠](https://github.com/JackGruber/joplin-plugin-backup/blob/master/README.md) | Simple Backup | 0.5.0 | Plugin to create manual and automatic backups. | JackGruber
